...
class _VerifyOtpState extends State<VerifyOtp> {
  ...
  verifyOtp() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('https://developmentalphawizz.com/financego/app/v1/api/v_verify_otp'));
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonresponse['error'] == false){
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(" User Login Success")));
