...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  getuserProfile() async{
    ...
    print('${id} ________________aaaaaaaaaaaa');
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                  ...
                  child: Row(
                    children: [
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Text('${getprofile?.data?.first.id}',style: TextStyle(color: primary,fontSize: 20),),
                          Text('SAM_Smith',style: TextStyle(color: primary,fontSize: 20),),
                          Text("View Profile",style: TextStyle(color: primary),)
                        ],
                      ),
                      InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (c)=>EditeProfile()));
                        },
          ...
          Padding(
            padding: const EdgeInsets.all(5.0),
            child: CustomDrawerTile(tileName: 'Need Help? ', tileIcon:Image.asset("assets/imgs/Need Help.png",scale: 1.7,),
              onTap: (){
